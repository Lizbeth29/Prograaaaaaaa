...
Chiclayo, Trujillo, Chimbote, Lima, Ica. El 54,6% de la población peruana vive en la costa, el
32,0% en la sierra, y el 13,4% en la selva. 
- Además, la costa peruana está afectada por el cruce de dos placas tectónicas: la de Nazca y la Continental, provocando, en su fricción, los sismos. 
...
<img src="erosion.jpg" width="300" height="300" /> | <img src="inunda.jpg" width="300" height="300" />
...
- **Hipótesis específicos:**
  ...
  - La influencia generada por la ersión de los suelos es negativa
...
-  Técnicas de recolección de datos
     - Obtención de datos con extensión shp
     - Software R
